...
class Club:
    ...
    def display_club_info():
        ...
        print("Kulüp Adı: Prestijli Kulüp")
        print("Üyelerimizin mutluluğu bizim için önceliklidir.")

    @staticmethod
    def log_event(description):
        Club.event_log.append(description)  # Olayı kaydet

    @staticmethod
    def show_event_log():
        print("Etkinlik Geçmişi:")
        for event in Club.event_log:
            print(event)
